...
# answer 2: changing the T to an F opens the layer controls
...
# Solution
#answer: yes, using "clusteroptions=markerclusteroptions()", by matt_jay on stackoverflow
...
# Your brief answer
# answer:
# clustered points make the map more readable, without clusters the map is basically useless
# as it is borderline unreadable and hardly navigable with all of the markers
...
# us the line popup = paste(places$Description, "<br>", places$Type) to get popup info and classification
